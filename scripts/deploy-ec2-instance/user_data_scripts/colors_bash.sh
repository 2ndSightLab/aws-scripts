...
echo 'echo -e "\e]11;{{prompt: Enter an html color like #000000 for black. Find colors at https://htmlcolorcodes.com/color-picker/}}\a"' >> ~/.bashrc
echo ''  >> ~/.bashrc
echo '#PS1'  >> ~/.bashrc
...
echo 'export PS1="{{prompt: Enter prompt such as a colon or greater than sign}} \e]0;{{prompt: Enter the title for terminal windows}}\a"' >> ~/.bashrc
echo ''  >> ~/.bashrc
